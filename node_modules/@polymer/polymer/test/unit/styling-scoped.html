...
HTMLImports.whenReady(function() {
  customElements.define('x-class-no-is', class extends $Element {
    static get template() {
      return window.xClass;
    }
  });

  customElements.define('x-template-string', class extends $Element {
    static get template() {
      return `<style>
        :host {
          display: block;
...
import { flush as $flush } from '../../lib/utils/flush.js';
