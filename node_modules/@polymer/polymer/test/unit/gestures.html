...
import { afterNextRender as $afterNextRender } from '../../lib/utils/render-status.js';
import * as $$gestures from '../../lib/utils/gestures.js';
import { resetMouseCanceller as $resetMouseCanceller, deepTargetFind as $deepTargetFind, recognizers as $recognizers, addListener as $addListener, removeListener as $removeListener } from '../../lib/utils/gestures.js';
...
suite('Reference Cleanup', function() {
  ...
  test('down and up clear document tracking', function() {
    ...
    var recognizers = $recognizers.filter(function(r) {
