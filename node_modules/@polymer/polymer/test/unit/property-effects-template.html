...
<dom-module id="x-runtime">
  ...
  <script type="module">
import { Element as $Element } from '../../polymer-element.js';
import { GestureEventListeners as $GestureEventListeners } from '../../lib/mixins/gesture-event-listeners.js';
import '../../lib/elements/dom-if.js';
import { DomModule as $DomModule } from '../../lib/elements/dom-module.js';
HTMLImports.whenReady(() => {
...
import '../../lib/elements/dom-if.js';
HTMLImports.whenReady(() => {
  class XParsing extends $Element {
...
import '../../lib/elements/dom-if.js';
HTMLImports.whenReady(() => {
  class XBinding extends $Element {
