...
HTMLImports.whenReady(function() {
  ...
  <dom-module id="single-behavior">
    <script type="module">
import '../../polymer.js';
import { mixinBehaviors as $mixinBehaviors } from '../../lib/legacy/class.js';
import { Element as $Element } from '../../polymer-element.js';
HTMLImports.whenReady(function() {
  customElements.define('single-behavior',
    $mixinBehaviors(Polymer.BehaviorA, $Element));
});
</script>
  </dom-module>
...
HTMLImports.whenReady(function() {
  customElements.define('lifecycle-behavior',
    $mixinBehaviors([Polymer.LifeCycleBehavior1,
      Polymer.LifeCycleBehavior2], $Element));
});
</script>
  </dom-module>
...
HTMLImports.whenReady(function() {
  customElements.define('multi-behaviors',
    class extends $mixinBehaviors(
      [Polymer.BehaviorA, Polymer.BehaviorB], $Element) {
...
suite('multi-behaviors element', function() {
  ...
  test('behavior array is unique', function() {
    customElements.define('behavior-unique', $mixinBehaviors(
      [Polymer.BehaviorA, Polymer.BehaviorA], $Element));
  ...
  test('duplicate behaviors keep first behavior', function() {
    customElements.define('behavior-unique-last-behavior', $mixinBehaviors(
      [Polymer.BehaviorA, Polymer.BehaviorB, Polymer.BehaviorC, Polymer.BehaviorA, Polymer.BehaviorB], $Element));
